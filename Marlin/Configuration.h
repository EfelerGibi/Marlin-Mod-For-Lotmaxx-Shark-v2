...
#define STRING_CONFIG_H_AUTHOR "(Efeler_Gibi, default config)" // Who made the changes.
...
#define PSU_NAME "Power Supply"
  ...
  //#define PSU_POWERUP_DELAY      0    // (ms) Delay for the PSU to warm up to full power
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 20, 0, -3.15 }
