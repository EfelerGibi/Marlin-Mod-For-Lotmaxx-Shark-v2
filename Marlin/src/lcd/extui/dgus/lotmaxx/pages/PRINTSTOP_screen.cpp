...
void DGUSScreenHandler::STOP_CancelButtonHandler(DGUS_VP_Variable &var, void *val_ptr)
{
...
void DGUSScreenHandler::STOP_ConfirmButtonHandler(DGUS_VP_Variable &var, void *val_ptr)
{
  ExtUI::stopPrint();
